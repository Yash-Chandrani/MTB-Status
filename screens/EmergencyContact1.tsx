...
const EmergencyContact = () => {
  ...
  return (
    <View style={styles.emergencyContact2}>
      <View style={styles.emergencyContact2Child} />
      <View style={styles.emergencyContact2Item} />
      <Pressable
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("EmergencyContact11")}
      >
        <Image
