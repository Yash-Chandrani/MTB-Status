...
const EmergencyContact2 = () => {
  ...
  return (
    <View style={styles.emergencyContact1}>
      <View style={styles.emergencyContact1Child} />
      <View style={styles.emergencyContact1Item} />
      <Pressable
      ...
      <Property1left
        ...
        searchColor="#8a8a8d"
        onSearchBarPress={() => navigation.navigate("EmergencyContact")}
      />
