...
const EmergencyContact4 = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.emergencyContact6}>
      <View style={styles.emergencyContact6Child} />
      <View style={styles.emergencyContact6Item} />
      <Pressable
      ...
      />
      <Alert2 onActionItemPress={() => navigation.navigate("HomePage1")} />
    </View>
  );
};
...
export default EmergencyContact4;
