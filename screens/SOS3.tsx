...
const SOS3 = () => {
  ...
  return (
    <View style={[styles.sos4, styles.sos4FlexBox]}>
      ...
      <FrameComponent1
        ellipse3={require("../assets/ellipse-32.png")}
        ellipse4={require("../assets/ellipse-43.png")}
      />
      <DarkModeFalseActionCount
        ...
        onActionsPress={() => navigation.navigate("HomePage1")}
        onActionItemPress={() => navigation.navigate("HomePage1")}
      />
    </View>
  );
};
